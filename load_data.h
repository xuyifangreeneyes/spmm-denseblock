#ifndef SPMM_DENSEBLOCK_LOAD_DATA
#define SPMM_DENSEBLOCK_LOAD_DATA
...
int loadGraphFromFile(const std::string& filename, std::vector<std::vector<int>>& edges);
