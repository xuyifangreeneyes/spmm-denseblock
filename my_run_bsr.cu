...
int getBSR(int n, int nnz, int bsize, int** hostBsrRowPtr, int** hostBsrColInd,
           float** hostBsrVal) {
...
int main() {
  ...
  cudaStat1 =
      cudaMemcpy(y, yHostPtr, (size_t)(nb * bsize * dim * sizeof(float)),
  ...
  cudaStat1 =
      cudaMemcpy(bsrRowPtr, hostBsrRowPtr, (size_t)((nb + 1) * sizeof(int)),
                 cudaMemcpyHostToDevice);
  ...
  cudaStat1 =
      cudaMemcpy(zHostPtr, z, (size_t)(nb * bsize * dim * sizeof(float)),
