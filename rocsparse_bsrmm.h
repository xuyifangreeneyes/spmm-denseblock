...
#define launch_bsrmmnt_small_blockdim_kernel(T, block_size, wf_size, bsr_block_dim)                                \
        bsrmmnt_small_blockdim_kernel<T, block_size, wf_size, bsr_block_dim><<<bsrmmnt_blocks, bsrmmnt_threads>>>( \
            dir, mb, n, alpha, bsr_row_ptr, bsr_col_ind, bsr_val, B, ldb, beta, C, ldc, idx_base);

#define launch_bsrmm_large_blockdim_kernel(T, bsr_block_dim, blk_size_y)                                \
        bsrmm_large_blockdim_kernel<T, bsr_block_dim, blk_size_y><<<bsrmm_blocks, bsrmm_threads>>>( \
...
#define launch_bsrmm_general_blockdim_kernel(T, bsr_block_dim, blk_size_y)                                \
        bsrmm_general_blockdim_kernel<T, bsr_block_dim, blk_size_y><<<bsrmm_blocks, bsrmm_threads>>>( \
            dir, trans_B, mb, n, alpha, bsr_row_ptr, bsr_col_ind, bsr_val, block_dim, B, ldb, beta, C, ldc, idx_base);

template <typename T, int BLOCKSIZE, int WF_SIZE, int BSR_BLOCK_DIM>
__launch_bounds__(BLOCKSIZE) __global__
    void bsrmmnn_small_blockdim_kernel(cusparseDirection_t direction,
                                       int mb,
                                       int n,
                                       T   alpha,
...
template <typename T, int BLOCKSIZE, int WF_SIZE, int BSR_BLOCK_DIM>
__launch_bounds__(BLOCKSIZE) __global__
    void bsrmmnt_small_blockdim_kernel(cusparseDirection_t direction,
                                       int mb,
                                       int n,
                                       T   alpha,
                                       const int* __restrict__ bsr_row_ptr,
...
__launch_bounds__(BSR_BLOCK_DIM* BLK_SIZE_Y) __global__
    void bsrmm_large_blockdim_kernel(cusparseDirection_t direction,
...
template <typename T, int BSR_BLOCK_DIM, int BLK_SIZE_Y>
__launch_bounds__(BSR_BLOCK_DIM* BLK_SIZE_Y) __global__
    void bsrmm_general_blockdim_kernel(cusparseDirection_t direction,
                                       cusparseOperation_t trans_B,
                                       int mb,
                                       int n,
                                       T   alpha,
